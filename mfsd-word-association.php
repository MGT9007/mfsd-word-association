...
final class MFSD_Word_Association {
    ...
    public function assets() {
        ...
        wp_register_style('mfsd-word-assoc-css', $url . 'mfsd-word-association.css', array(), $ver);
        wp_register_script('mfsd-word-assoc-js', $url . 'mfsd-word-association.js', array(), $ver, true);
    }
